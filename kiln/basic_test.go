...
func TestQueueing(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		enqueued, err := Schedule(nil, tester.Store, &job, 0, 0)
		...
		dequeued, attempt, err := Claim(nil, tester.Store, &job, time.Hour)
		assert.NoError(t, err)
		...
		job.Data = "Hello!!!"
		err = Terminate(nil, tester.Store, &job)
		assert.NoError(t, err)
...
func TestQueueingDelayed(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		enqueued, err := Schedule(nil, tester.Store, &job, 100*time.Millisecond, 0)
		assert.NoError(t, err)
		assert.True(t, enqueued)
		assert.NotZero(t, job.ID())
...
func TestDequeueTimeout(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		dequeued, attempt, err := Claim(nil, tester.Store, &job, 100*time.Millisecond)
		assert.NoError(t, err)
		assert.True(t, dequeued)
		assert.Equal(t, 1, attempt)
...
func TestFail(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		err = Crash(nil, tester.Store, &job, "some error", 0)
		assert.NoError(t, err)
...
func TestFailDelayed(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		err = Crash(nil, tester.Store, &job, "some error", 100*time.Millisecond)
		assert.NoError(t, err)
...
func TestEnqueueLabeled(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		enqueued, err := Schedule(nil, tester.Store, &job1, 0, 0)
		assert.NoError(t, err)
		assert.True(t, enqueued)
		...
		enqueued, err = Schedule(nil, tester.Store, &job2, 0, 0)
		assert.NoError(t, err)
		...
		_, _, err = Claim(nil, tester.Store, &job1, time.Second)
		assert.NoError(t, err)

		err = Terminate(nil, tester.Store, &job1)
		assert.NoError(t, err)
...
func TestEnqueueIsolation(t *testing.T) {
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		...
		enqueued, err = Schedule(nil, tester.Store, &job2, 0, 100*time.Millisecond)
		assert.NoError(t, err)
		assert.False(t, enqueued)
		assert.NotZero(t, job2.ID())
...
func TestValidation(t *testing.T) {
	...
	withTester(t, func(t *testing.T, tester *fire.Tester) {
		ok, err := Schedule(nil, tester.Store, job, 0, 0)
		assert.Error(t, err)
		assert.False(t, ok)
